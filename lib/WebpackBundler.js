    ...
    return {
            ...
            bundlers.get(this).set("ready",
                ...
                .then(dict => new Promise(resolve => {
                    nextTick(() => {
                      ...
                      if ( dict.target) this.target = dict.target
                      ...
                      ;(dict.raw||[...DEFAULT_RAW]).forEach(raw => {
                      ...
                      this.cssloader_configuration = (dict.cssloader||empty).configuration||{}
                ...
                return bundlers.get(this).get("ready")
                  ...
                  .then(() => new Promise((resolve, reject) => {
                      ...
                      webpack({
                        ...
                        , resolve: wp_resolve
                        , output: {
                              path: resolvePath(this.target, dirname(this.to_js))
                        ...
                        , module: {
                              loaders: [
                                ...
                                , {
                                    test: /\.css$/,
                                    loader: ExtractTextPlugin.extract(`css-loader?modules&importLoaders=1&${this.cssloader_configuration}!postcss-loader`)
                                  }
                                , {
      ...
      , cssloader_configuration: { enumerable: true,
          ...
          , set: function(v){
                ...
                bundlers.get(this).set("cssloader_configuration", JSON.parse(JSON.stringify(v)))
            }
        }
      ...
      , target: { enumerable: true,
            get: function(){ return bundlers.get(this).get("target") || TMP }
          , set: function(v){
                bundlers.get(this).set("target", typeOf(v) == "string"
                                               ? isAbsoluePath(v) ? v : (console.warn(`webpackBundler.target must be an absolute path (was requested: ${v}, will use: ${TMP})`), TMP)
                                               : void function(){ throw new TypeError("target, path (string) expected")  }())
            }
        }
